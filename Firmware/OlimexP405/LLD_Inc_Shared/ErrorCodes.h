...
typedef enum
{
	...
	ERROR_NOT_IMPLEMENTED  = 0x00000011, //This method is not implemented
	...
	ERROR_ISO9141_INITFAIL  = 0x00000402, //<! 5 Baud init has failed
	ERROR_ISO9141_NOOBDSNS  = 0x00000403, //<! Init can't start because OBD voltage is missing
