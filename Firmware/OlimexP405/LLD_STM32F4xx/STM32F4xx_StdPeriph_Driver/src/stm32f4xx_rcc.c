...
/**
  ...
  *          the clocks frequencies.
	*
	* @param  HseValue: Set here HSE_VALUE from stm32f4xx_conf.h or if you are using 
	*         Genesis, then choose those value on given version of PCB
  *     
  ...
  * @retval None
  */
void RCC_GetClocksFreq(RCC_ClocksTypeDef* RCC_Clocks, uint32_t HseValue)
{
  ...
  switch (tmp)
  {
    ...
    case 0x04:  /* HSE used as system clock  source */
      RCC_Clocks->SYSCLK_Frequency = HseValue;
      break;
    case 0x08:  /* PLL used as system clock  source */
      ...
      if (pllsource != 0)
      {
        ...
        pllvco = (HseValue / pllm) * ((RCC->PLLCFGR & RCC_PLLCFGR_PLLN) >> 6);
      }
      else
      {
